...
namespace SeDes
{
    class Program
    {
        ...
        public static string DoSerialization() {
            Product[] products = {
                new Product{ ID = 0, Name = "Cafe", Price = 7.8},
                new Product{ ID = 1, Name  = "Cacao", Price = 10.9},
                new Product{ ID = 2, Name  = "Arroz", Price = 42.1},
                new Product{ ID = 3, Name  = "Leche", Price = 0}
            };
       ...
       /* public static void DoDeserialization(string json) {
        ...
        public static void DoDeserialization(string json) {
            ...
            foreach (var product in products) {
                System.Console.WriteLine($"Target:{product.Name} Speed:{product.Price}");
            }
        }
    }
}
